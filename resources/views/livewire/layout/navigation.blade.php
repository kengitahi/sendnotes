...
<nav class="bg-white border-b border-gray-100 dark:border-gray-700 dark:bg-gray-800" x-data="{ open: false }">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :active="request()->routeIs('notes.index')" :href="route('notes.index')" wire:navigate>
                        {{ __('Notes') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :active="request()->routeIs('dashboard')" :href="route('dashboard')" wire:navigate>
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :active="request()->routeIs('notes.index')" :href="route('notes.index')" wire:navigate>
                {{ __('Notes') }}
            </x-responsive-nav-link>
        </div>
